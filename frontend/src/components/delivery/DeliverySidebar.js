...
import { FaChartBar, FaClipboardList, FaSignOutAlt, FaClock } from "react-icons/fa";
      ...
      <Box>
        ...
        <Flex direction="column" gap={4}>
          ...
          <Button
            ...
            justifyContent="start"
            _hover={{ bg: "teal.100", color: "teal.700" }}
            onClick={() => handleNavigation("/all-deliveries")}
          ...
          <Button
            ...
            justifyContent="start"
            _hover={{ bg: "teal.100", color: "teal.700" }}
            onClick={() => handleNavigation("/pending-deliveries")}
